...
export class ProveedorService {
  ...
  registrarCompra(id: number, dto: { sucursalId: number; numeroFactura?: string | null; total: number; itbis: number; tipoBienServicio?: string | null; notas?: string | null; contado: boolean }) {
